...
* refs
  [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws-frequently-used-commands.org][AWS, frequently used commands]]
...
* TODO understand [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/hibernation_for_aws_ec2.org][hibernation for AWS EC2]]
* to launch an EC2 instance for tax.co.web "from scratch"
** PITFALL: *WAY EASIER* is to [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_ami_amazon_machine_image.org#to-launch-an-ec2-instance-from-an-ami][use the existing AMI]] called "tax.co(.web)"
...
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web_on_ec2.org#to-login-use-ofssh-ofsh][log into it]]
...
** git
   git config --global core.editor "emacs -nw"
     (details [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/git_version_control_software.org#configure-git-so-emacs-is-the-default-editor][here]])
...
** update native [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws-frequently-used-commands.org#define-my-aws-related-shell-variables][record of the]] IPv4 Public IP address for the EC2 instance
   and login
** in [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/aws_route53.org][AWS Route53]], associate a domain name with the EC2 instance
** start the docker container
** TODO add more steps -- start services in the docker container?
** visit [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#online][manual_ingest online]]
