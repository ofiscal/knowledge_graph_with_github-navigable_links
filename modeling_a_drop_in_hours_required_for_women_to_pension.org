...
** How to compute state transition probabilities?
   e.g. [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/evaluacion_de_politicas_pensionales_para_reducir_la_brecha_de_genero_en_la_etapa_de_retiro_en_colombia_by_andrea_lizeth_lopez_rodriguez.org#estimates-how-probability-of-state-transitions][the way Andrea López does]]
* [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/evaluacion_de_politicas_pensionales_para_reducir_la_brecha_de_genero_en_la_etapa_de_retiro_en_colombia_by_andrea_lizeth_lopez_rodriguez.org]["Evaluación de políticas pensionales para reducir la brecha de género en la etapa de retiro en Colombia", by Andrea Lizeth López Rodríguez]]
