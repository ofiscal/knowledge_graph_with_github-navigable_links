...
* SEE ALSO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org][tax.co.web]]
* refs
** github
   https://github.com/ofiscal/tax.co
   git clone git@github.com:ofiscal/tax.co.git
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_the_paper_about.org][tax.co, the paper about]]
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tricks.org][tricks - how to do some things]]
...
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/un_hardcode_those_zero_income_tests_tax_co.org][un-hardcode those zero-income tests \ tax.co]]
...
* TODO | PITFALL: [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/do_not_exceed_daily_automatic_gmail_send_limit.org][Do not exceed daily automatic Gmail send limit.]]
* TODO long-term: use [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/geih.org][geih]] to supplement the [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/enph.org][enph]]
** some people Oliver thinks could help
   [[https://github.com/JeffreyBenjaminBrown/secret-org/blob/master/jairo_nunez.org][Jairo Nuñez]] + David Guerrero (Externado) + someone junior (ask him)
...
* verify we don't use retencion en la fuente
  P1652S2 & P1652S2A1
* [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/extending_tax_co_with_quantile_data_from_dian.org][extending tax.co with quantile data from DIAN]]
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/gender_split_data_sets_might_have_bad_quantile_definitions.org][gender-split data sets might have bad quantile definitions]]
...
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org][put tax.co online]]
* TODO clean
** try pydoc
...
* TODO test suite
** TODO [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/tests_and_io_computer_programming.org][tests and IO (computer programming)]]
...
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/makefile_running_var_summaries_by_group_py_too_many_times_from_cron_job_bug_tax_co_web.org][Makefile *still* <2023-09-08 Fri> running baseline programs when nothing has changed \ bug, tax.co.web]]
...
** NAH [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/install_python_3_12_in_ubuntu.org][install python 3.12 in Ubuntu]]
...
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/run_models_anticipating_tax_reform.org][run models anticipating tax reform]]
