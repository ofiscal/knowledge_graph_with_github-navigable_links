...
* goals of theirs that we can advance
  ...
  (from [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/getting_a_grant_from_the_global_partnership_for_social_accountability.org#their-call-for-proposals][their Call for Proposals]])
* requirements
  apply in English
