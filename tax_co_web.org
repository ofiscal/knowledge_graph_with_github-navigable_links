...
#+title: tax.co.web
* refs
  [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#online][manual_ingest online]]
...
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/how_to_onboard_someone_to_the_tax_co_repositories.org][how to onboard someone to the tax.co* repositories]]
...
* TODO resume filing [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#todo-to-promote][here]] downward
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/make_tax_co_web_publishable.org][make tax.co.web publishable]]
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/let_user_modify_ss_taxes.org][let user modify SS taxes]]
...
* internalizing: [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/to_change_sample_size_in_tax_co_web.org][to change sample size in tax.co.web]]
* streamline [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web_s_request_queue.org][tax.co.web's request queue]]
* ? rename the "detail" strategy to "default"
* TODO ? Use [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/parquet_file_format.org][parquet (file format)]].
* PITFALLs
** if csv files have the wrong (i.e. Windows-style) line terminators
   [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/csvlib_python_library.org#use-linux--not-windows-style-line-terminators][how to use Linux-, not Windows-style, line terminators in csvlib]]
...
* TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/daniel_s_ingresos_xlsx.org][Daniel's "ingresos.xlsx"]]
* TODO important
...
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#todo-generate-pictures][generate pictures]]
** [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#todo-enable-xlsx-or-csv-upload][enable .xlsx or .csv upload]]
...
** TODO [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#todo-handle-return-codes-1][handle return codes]]
* TODO easy
** un-hardcode this path
   secrets_path = "/mnt/apache2/secret"
   in tax.co/python/email.py
** [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/collect_all_tax_co_and_tax_co_web_paths_in_a_single_repo_file.org][collect all tax.co and tax.co.web paths in a single (repo? file?)]]
...
*** read shell variables from a .json file
    Using [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/jq_shell_command.org][jq (shell command)]].
...
** TODO ? email addresses with strange characters
   ...
   Are they important?
* in Apache
** ? In Docker image, customize further [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/apache-web-server.org#todo--pitfall-might-need-more-customization][for Apache]] and [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/wsgi.org][wsgi]]
...
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/fix_how_exemptions_are_applied_to_most_income.org][fix how exemptions are applied to "most income"]]
** DONE dynamic forms
*** the idea
**** for the IVA
...
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#done-what-figures-out-which-one-to-run-next][What figures out which one to run next?]]
...
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#test-taxco-by-hand][test the program (by hand)]]
** DONE [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/give_appuser_apache_privileges.org][giving Apache privileges to a Docker user]]
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#done-run-taxco-as-a-cron-job-1][run tax.co as a cron job]]
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#done-email-results-to-user][email results to user]]
** DONE [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/django_security_things_to_do_before_production.org][Django security, things to do before production]]
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/graph_changes_in_tax_burden_by_decile.org][graph changes in tax burden by decile]]
...
:END:
**** ownserhip is weird
     Everything touched by either [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#the-python3-call-works][the python3 call]] or [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_web.org#running-tax_co_cronsh-by-hand-works][running tax_co_cron.sh by hand]] is owned on the native EC2 system by
...
**** Never had to [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/python_script_works_unless_run_by_cron.org][ask the internets]].
**** Verify the same happens on EC2
** DONE choose a [[https://github.com/JeffreyBenjaminBrown/public-notes-in-org-roam-format/blob/master/web_server.org][web server]]
** DONE [[https://github.com/JeffreyBenjaminBrown/ofiscal/knowledge-graph/blob/master/tax_co_person_level_analysis.org][tax.co person-level analysis]]
